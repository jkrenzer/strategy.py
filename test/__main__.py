...
rootParser.add('--coverage-output', help='generate the output in this folder or file. HTML needs a directory here', default='./.coverage_report', type=Path)
...
if __name__ == '__main__':
    ...
    if options.coverage_report:
        ...
        if options.coverage_report == 'html':
            cov.html_report(
                directory= str(options.coverage_output.stem)
            )
